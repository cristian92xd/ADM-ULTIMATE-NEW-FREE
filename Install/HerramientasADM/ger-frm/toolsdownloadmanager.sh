...
vnc () {
wget -O /etc/ger-frm/payySND https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUQ/ADM-ULTIMATE-NEW-FREE/master/Install/HerramientasADM/payySND > /dev/null 2>&1; chmod +x /etc/ger-frm/payySND
fun_bar "chmod -R 777 /etc/ger-frm/payySND"
chmod -R 777 /etc/ger-frm/vnc.sh > /dev/null 2>&1
msg -bar
echo -e "${cor[3]} DESCARGADO CON SUCCESO EN: ${cor[2]}Menu de herramientas"
return
